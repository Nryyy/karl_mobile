...
abstract final class AppTheme {
  ...
  static TextTheme _buildTextTheme(ColorScheme colorScheme) {
    ...
    return base.copyWith(
      displayLarge: base.displayLarge?.copyWith(color: colorScheme.onSurface, letterSpacing: -0.25),
      ...
      headlineLarge: base.headlineLarge?.copyWith(color: colorScheme.onSurface, letterSpacing: -0.5),
      ...
      titleLarge: base.titleLarge?.copyWith(color: colorScheme.onSurface, fontWeight: FontWeight.w600),
      titleMedium: base.titleMedium?.copyWith(color: colorScheme.onSurface, fontWeight: FontWeight.w600, letterSpacing: 0.15),
      titleSmall: base.titleSmall?.copyWith(color: colorScheme.onSurface, fontWeight: FontWeight.w600, letterSpacing: 0.1),
      bodyLarge: base.bodyLarge?.copyWith(color: colorScheme.onSurface, height: 1.5),
      bodyMedium: base.bodyMedium?.copyWith(color: colorScheme.onSurfaceVariant, height: 1.43),
      bodySmall: base.bodySmall?.copyWith(color: colorScheme.onSurfaceVariant),
      labelLarge: base.labelLarge?.copyWith(color: colorScheme.onSurface, fontWeight: FontWeight.w600, letterSpacing: 0.1),
      labelMedium: base.labelMedium?.copyWith(color: colorScheme.onSurfaceVariant, fontWeight: FontWeight.w600),
      labelSmall: base.labelSmall?.copyWith(color: colorScheme.onSurfaceVariant, fontWeight: FontWeight.w600),
    );
  }

  static AppBarTheme _buildAppBarTheme(ColorScheme colorScheme, {bool isDark = false}) => AppBarTheme(
        elevation: 0,
  ...
  static CardThemeData _buildCardThemeData(ColorScheme colorScheme, {bool isDark = false}) => CardThemeData(
        elevation: 0,
  ...
  static FilledButtonThemeData _buildFilledButtonTheme(ColorScheme colorScheme) => FilledButtonThemeData(
  ...
  static InputDecorationTheme _buildInputDecorationTheme(ColorScheme colorScheme, {bool isDark = false}) => InputDecorationTheme(
        filled: true,
        fillColor: isDark ? colorScheme.surfaceContainerHighest : colorScheme.surfaceContainerLow,
        ...
        labelStyle: GoogleFonts.inter(fontSize: 14, fontWeight: FontWeight.w500, color: colorScheme.onSurfaceVariant),
        hintStyle: GoogleFonts.inter(fontSize: 14, fontWeight: FontWeight.w400, color: colorScheme.onSurfaceVariant.withValues(alpha: 0.6)),
      );

  static NavigationBarThemeData _buildNavigationBarTheme(ColorScheme colorScheme) => NavigationBarThemeData(
        backgroundColor: colorScheme.surfaceContainer,
        indicatorColor: colorScheme.secondaryContainer,
        indicatorShape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16)),
        labelTextStyle: WidgetStateProperty.resolveWith((states) =>
            states.contains(WidgetState.selected)
                ? GoogleFonts.inter(fontSize: 12, fontWeight: FontWeight.w600, color: colorScheme.onSecondaryContainer)
                : GoogleFonts.inter(fontSize: 12, fontWeight: FontWeight.w500, color: colorScheme.onSurfaceVariant)),
  ...
  static ChipThemeData _buildChipTheme(ColorScheme colorScheme) => ChipThemeData(
        ...
        labelStyle: GoogleFonts.inter(fontSize: 12, fontWeight: FontWeight.w500, color: colorScheme.onSurfaceVariant),
        secondaryLabelStyle: GoogleFonts.inter(fontSize: 12, fontWeight: FontWeight.w600, color: colorScheme.onSecondaryContainer),
        padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 8),
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8)),
        side: BorderSide.none,
      );

  static DialogThemeData _buildDialogThemeData(ColorScheme colorScheme) => DialogThemeData(
        backgroundColor: colorScheme.surfaceContainerHighest,
  ...
  static SnackBarThemeData _buildSnackBarTheme(ColorScheme colorScheme) => SnackBarThemeData(
        ...
        contentTextStyle: GoogleFonts.inter(fontSize: 14, fontWeight: FontWeight.w500, color: colorScheme.onInverseSurface),
  ...
  static DividerThemeData _buildDividerTheme(ColorScheme colorScheme) =>
      DividerThemeData(color: colorScheme.outlineVariant, thickness: 1, space: 1);
  ...
  static FloatingActionButtonThemeData _buildFABTheme(ColorScheme colorScheme) => FloatingActionButtonThemeData(
        ...
        extendedTextStyle: GoogleFonts.inter(fontSize: 14, fontWeight: FontWeight.w600, letterSpacing: 0.1),
      );
