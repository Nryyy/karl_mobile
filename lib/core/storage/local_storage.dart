...
class LocalStorage {
  ...
  static const _cachedSentToMeDocumentsKey =
      'karl_cached_sent_to_me_documents_v1';
  ...
  static const _sentToMeDocumentsTimestampKey =
      'karl_sent_to_me_documents_timestamp_v1';
  ...
  static Future<List<DocumentListItem>> loadCachedDocuments() async {
    try {
      ...
      final documents = decoded
          .map(
            (e) =>
                DocumentListItem.fromJson(Map<String, dynamic>.from(e as Map)),
          )
          .toList(growable: false);

      developer.log(
        'Loaded ${documents.length} cached documents',
        name: 'karl.storage',
      );
      return documents;
    } catch (e) {
      developer.log(
        'Failed to load cached documents: $e',
        name: 'karl.storage',
        error: e,
      );
      return const <DocumentListItem>[];
  ...
  static Future<void> clearCachedDocuments() async {
    try {
      ...
      developer.log(
        'Failed to clear cached documents: $e',
        name: 'karl.storage',
        error: e,
      );
    }
  ...
  static Future<void> saveCachedSentToMeDocumentsJson(String json) async {
    try {
      ...
      await prefs.setString(
        _sentToMeDocumentsTimestampKey,
        DateTime.now().millisecondsSinceEpoch.toString(),
      );
      developer.log(
        'Sent-to-me documents cached successfully',
        name: 'karl.storage',
      );
    } catch (e) {
      developer.log(
        'Failed to cache sent-to-me documents: $e',
        name: 'karl.storage',
        error: e,
      );
    }
  ...
  static Future<List<DocumentListItem>> loadCachedSentToMeDocuments() async {
    try {
      ...
      developer.log(
        'Failed to load cached sent-to-me documents: $e',
        name: 'karl.storage',
        error: e,
      );
      return const <DocumentListItem>[];
  ...
  static Future<void> clearCachedSentToMeDocuments() async {
    try {
      ...
      developer.log(
        'Cached sent-to-me documents cleared',
        name: 'karl.storage',
      );
    } catch (e) {
      developer.log(
        'Failed to clear cached sent-to-me documents: $e',
        name: 'karl.storage',
        error: e,
      );
    }
  ...
  static Future<void> clearCachedUsers() async {
    try {
      ...
      developer.log(
        'Failed to clear cached users: $e',
        name: 'karl.storage',
        error: e,
      );
    }
  ...
  static Future<UserProfile?> loadCachedCurrentUser() async {
    try {
      ...
      developer.log(
        'Failed to load cached current user: $e',
        name: 'karl.storage',
        error: e,
      );
      return null;
  ...
  static Future<void> clearCachedCurrentUser() async {
    try {
      ...
      developer.log(
        'Failed to clear cached current user: $e',
        name: 'karl.storage',
        error: e,
      );
    }
