...
class BottomNavBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final List<_NavItem> items = <_NavItem>[
      ...
      _NavItem(
        label: loc?.documents ?? 'Documents',
        icon: Icons.description_outlined,
        selectedIcon: Icons.description,
        route: '/documents',
      ),
      _NavItem(
        label: loc?.approvals ?? 'Approvals',
    ...
    return NavigationBar(
      selectedIndex:
          items.indexWhere((e) => currentRoute.startsWith(e.route)) >= 0
          ? items.indexWhere((e) => currentRoute.startsWith(e.route))
          : 0,
